...
profile = lkl_prof(
  chains_dir="/user/p8_group/gr_ADNSS/Swanith/runs/montepython/2026-07-31_lcdm_desy5_only/",
  prof_param='Omega_m',
  info_root="2026-07-31_lcdm_desy5_only",
)
...
profile.global_min(N_min_steps=N_STEPS)
...
profile.run_lkl_prof(time_mins=True, N_min_steps=N_STEPS)
